...
el("bowlerRows").innerHTML =       <div class="table-row">       <span class="name"><span class="star">*</span> ${bowlerId}</span>       <span>${overs}</span>       <span>${maidens}</span>       <span>${runs}</span>       <span>${wickets}</span>       <span>${eco}</span>       </div>      ;
}
...
el("popupSelect").innerHTML =       <option value="">-- Select --</option>       <option value="PLAYER_1">PLAYER_1</option>       <option value="PLAYER_2">PLAYER_2</option>       <option value="PLAYER_3">PLAYER_3</option>      ;
